...
check_contains "homepage" "/" "CodePulse API"
check_contains "openapi" "/openapi.json" "/web/search"
check_contains "openapi" "/openapi.json" "/web/markdown"
check_contains "x402 metadata" "/.well-known/x402.json" "10000"
check_contains "agent-card" "/.well-known/agent-card.json" "webSearch"
check_contains "agent-card" "/.well-known/agent-card.json" "webScrape"
...
check_payment_challenge "web search" "/web/search" '{"query":"test"}' "30000"
check_payment_challenge "web markdown" "/web/markdown" '{"url":"https://example.com"}' "30000"
check_payment_challenge "web scrape" "/web/scrape" '{"url":"https://example.com"}' "30000"
check_payment_challenge "mailbox create" "/mailbox/create" '{}' "10000"
check_payment_challenge "phone temp sms" "/phone/temp-sms" '{}' "150000"
check_payment_challenge "webhook listen" "/webhook/listen" '{}' "10000"
check_payment_challenge "domain check" "/domain/check" '{"domain":"google.com"}' "10000"
check_payment_challenge "registry npm" "/registry/npm" '{"package":"express"}' "5000"
check_payment_challenge "security secret-scan" "/security/secret-scan" '{"text":"no secrets"}' "15000"
check_payment_challenge "media pdf-text" "/media/pdf-text" '{"url":"https://example.com/sample.pdf"}' "50000"
echo ""
