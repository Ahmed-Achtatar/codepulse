...
<head>
  ...
  <title>CodePulse API - Web, Scraping & Developer Utilities for AI Agents</title>
  <link rel="icon" type="image/png" href="/logo.png">
  <link rel="apple-touch-icon" href="/logo.png">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="CodePulse API">
  <meta property="og:title" content="CodePulse API — Web, Scraping & Developer Utilities for AI Agents (x402)">
  <meta property="og:description" content="50 pay-per-call tools for AI agents: web scraping, markdown downloads, disposable inboxes, webhooks, domain verification, and registry lookups. x402 USDC on Base, no API key.">
  <meta property="og:image" content="${baseUrl}/logo.png">
  <meta property="og:url" content="${baseUrl}">
  <meta name="twitter:card" content="summary">
  <meta name="twitter:title" content="CodePulse API — x402 tools for AI agents">
  <meta name="twitter:description" content="50 pay-per-call tools for AI agents: web scraping, markdown downloads, disposable inboxes, webhooks, domain verification, and registry lookups. x402 USDC on Base, no API key.">
  ...
  <style>
    :root {
      ...
      --panel-strong: rgba(7, 10, 20, 0.85);
      --line: rgba(255, 255, 255, 0.05);
      --line-hover: rgba(56, 189, 248, 0.3);
      --text: #f8fafc;
      --muted: #8b9bb4;
      --accent: #38bdf8;
    ...
    * {
    ...
    body {
      ...
      background-image: 
        ...
        radial-gradient(circle at 85% 90%, rgba(52, 211, 153, 0.05) 0%, transparent 40%);
      color: var(--text);
    ...
    .hero {
      ...
      gap: 32px;
      align-items: center;
      animation: fadeInDown 0.8s cubic-bezier(0.2, 0.8, 0.2, 1) 0.1s both;
    }
    ...
    .use-case-card::before {
      ...
      background: radial-gradient(800px circle at var(--mouse-x) var(--mouse-y), rgba(56, 189, 248, 0.06), transparent 40%);
      opacity: 0;
    ...
    .use-case-card.featured {
      ...
      background: linear-gradient(145deg, rgba(52, 211, 153, 0.03), rgba(255, 255, 255, 0.01));
      box-shadow: 0 0 25px rgba(52, 211, 153, 0.08);
      position: relative;
      overflow: hidden;
    }

    .use-case-card.featured::after {
    ...
    .use-case-card.featured:hover {
      ...
      background: linear-gradient(145deg, rgba(52, 211, 153, 0.05), rgba(255, 255, 255, 0.02));
      box-shadow: 0 15px 40px rgba(0, 0, 0, 0.4), 0 0 30px rgba(52, 211, 153, 0.15);
    }
...
<body>
  ...
  <main class="wrap">
    ...
    <section class="panel integration-docs">
      <h2>Add CodePulse to your IDE (MCP Config)</h2>
      <p style="color: var(--muted); font-size: 0.95rem; margin-bottom: 16px;">
        CodePulse runs a Model Context Protocol (MCP) server. You can integrate all 50+ tools directly into <strong>Cursor</strong>, <strong>Windsurf</strong>, or <strong>Claude Desktop</strong>.
      </p>
  ...
  <footer>
    <div class="wrap">
      <span>&copy; 2026 CodePulse API. Served via Cloudflare Workers. All rights reserved.</span>
  ...
  <script>
    ...
    document.getElementById("use-cases-grid").onmousemove = e => {
      for(const card of document.getElementsByClassName("use-case-card")) {
